                ...
                <div class="row gy-4">
                    <div class="col-md-4">
                        <div class="bg-light d-flex flex-column justify-content-center p-4">
                            ...
                            <p class="mb-2"><i class="fa fa-envelope text-primary me-2"></i>book@example.com</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="bg-light d-flex flex-column justify-content-center p-4">
                    ...
                    <div class="col-md-4">
                        <div class="bg-light d-flex flex-column justify-content-center p-4">
                            ...
                            <p class="mb-2"><i class="fa fa-envelope text-primary me-2"></i>tech@example.com</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <form action="{{ route('contact.submit') }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="message" placeholder="Leave a message here" id="message" style="height: 150px" required>{{ old('message') }}</textarea>
